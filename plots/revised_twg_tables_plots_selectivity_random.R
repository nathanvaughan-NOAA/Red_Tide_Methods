...
# This version uses just the random_34 selectivity, none of the core or all_yrs
...
# 
# if(save == TRUE){
#   ggsave(file.path(run_SSMSE_dir,"plots_random", "ts_mean_F_5_core.png"),
...
# 
# if(save == TRUE){
#   ggsave(file.path(run_SSMSE_dir,"plots_random", "ts_mean_F_5_all_yrs.png"),
...
if(save == TRUE){
  ggsave(file.path(run_SSMSE_dir,"plots_random", "ts_mean_F_5_sel_rt_2.png"),
         width = 8, height = 6, units = "in", device = "png")
}
...
if(save == TRUE){
  ggsave(file.path(run_SSMSE_dir,"plots_random", "ts_mean_F_5_sel_all_yrs.png"),
         width = 8, height = 6, units = "in", device = "png")
}
...
# 
# if(save == TRUE){
#   save_kable(kable_core, file = file.path(run_SSMSE_dir,"plots_random","core_kable.html"))
# }
...
# 
# if(save == TRUE){
#   save_kable(kable_all_yrs, file = file.path(run_SSMSE_dir,"plots_random","all_years_kable.html"))
# }
...
if(save == TRUE){
  save_kable(kable_sel_rt_2, file = file.path(run_SSMSE_dir,"plots_random","sel_rt_2_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_sel_all_yrs, file = file.path(run_SSMSE_dir,"plots_random","sel_all_yrs_kable.html"))
}
...
# 
# if(save == TRUE){
#   save_kable(kable_core, file = file.path(run_SSMSE_dir,"plots_random","core_longterm_kable.html"))
# }
...
# 
# if(save == TRUE){
#   save_kable(kable_all_yrs, file = file.path(run_SSMSE_dir,"plots_random","all_years_longterm_kable.html"))
# }
...
if(save == TRUE){
  save_kable(kable_sel_rt_2, file = file.path(run_SSMSE_dir,"plots_random","sel_rt_2_longterm_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_sel_all_yrs, file = file.path(run_SSMSE_dir,"plots_random","sel_all_yrs_longterm_kable.html"))
}
...
create_reccom_plot <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2116") {
  ...
  if(save == TRUE){
    ggsave(file.path(run_SSMSE_dir,"plots_random", paste0(title, ".png")),
           width = 8, height = 6, units = "in", device = "png")
  }
}
...
create_reccom_plot_self_ref <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2116") {
  ...
  if(save == TRUE){
    ggsave(file.path(run_SSMSE_dir, "plots_random", paste0(title,"_self_ref", ".png")),
...
create_deadb_bias_plot_self_ref <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2116") {
  ...
  if(save == TRUE){
    ggsave(file.path(run_SSMSE_dir, "plots_random", paste0(title, "self_ref.png")),
           plot = p, width = 8, height = 6, units = "in", device = "png")
  }
...
create_recruitment_bias_plot <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2116") {
  ...
  EM_runs %>%
    ...
    ggtitle(paste0("Recruitment from ", min_year, "-", max_year, " for each fleet - ", scenario_name)) + xlab("OM name") + ylab("% Bias") +
    geom_hline(yintercept = 1, linetype = "dashed") # switch if you want the median line of the rt_2_x_rt_2
  #geom_hline(data = median_rt_2, aes(yintercept = median_om_em), linetype = "dashed")
  if(save == TRUE){
    ggsave(file.path(run_SSMSE_dir, "plots_random", paste0(title, ".png")),
...
create_ssb_bias_plot <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2116") {
  ...
  EM_runs %>%
    ...
    ggtitle(paste0("SSB from ", min_year, "-", max_year, " for each fleet - ", scenario_name)) + xlab("OM name") + ylab("% Bias") +
    geom_hline(yintercept = 0, linetype = "dashed") # switch if you want the median line of the rt_2_x_rt_2
  #geom_hline(data = median_rt_2, aes(yintercept = median_om_em), linetype = "dashed")
  if(save == TRUE){
    ggsave(file.path(run_SSMSE_dir, "plots_random", paste0(title, ".png")),
...
ggplot(plot_data, aes(x = year, y = med_val)) +
  ...
  ggtitle("DeadB of Rec over time by OM") + xlab("DeadB (MT)")
...
plot_data <- summary$ts %>%
  filter(
    scenario %in% c(selectivity_rt_2, "rt_2_x_no_rt"),
    str_detect(model_run, "OM"),
    year >= 2017,
    year <= 2047
  ) %>%
...
ggplot(plot_data, aes(x = year, y = med_val)) +
  ...
  ggtitle("DeadB of Rec over time of OM data by EM") + xlab("DeadB (MT)")
...
ggplot(plot_data, aes(x = year, y = med_val)) +
  geom_ribbon(aes(ymin = low, ymax = high, fill = em_name), alpha = 0.2) +
  geom_line(aes(color = em_name)) + 
  ggtitle("SpawnBio over time of OM data by EM") + xlab("SpawnBio (MT)")
