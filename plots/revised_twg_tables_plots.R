...
# This version uses the selectivity_100_redo_2, so no random_34 runs
# This was the original script so most plots were sourced from here.  
...
if(save == TRUE){
  ggsave(file.path(run_SSMSE_dir,"plots", "ts_mean_F_5_core.png"),
...
if(save == TRUE){
  ggsave(file.path(run_SSMSE_dir,"plots", "ts_mean_F_5_all_yrs.png"),
...
if(save == TRUE){
  ggsave(file.path(run_SSMSE_dir,"plots", "ts_mean_F_5_sel_rt_2.png"),
         width = 8, height = 6, units = "in", device = "png")
}
...
if(save == TRUE){
  ggsave(file.path(run_SSMSE_dir,"plots", "ts_mean_F_5_sel_all_yrs.png"),
         width = 8, height = 6, units = "in", device = "png")
}
...
if(save == TRUE){
  save_kable(kable_core, file = file.path(run_SSMSE_dir,"plots","core_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_all_yrs, file = file.path(run_SSMSE_dir,"plots","all_years_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_sel_rt_2, file = file.path(run_SSMSE_dir,"plots","sel_rt_2_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_sel_all_yrs, file = file.path(run_SSMSE_dir,"plots","sel_all_yrs_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_core, file = file.path(run_SSMSE_dir,"plots","core_longterm_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_all_yrs, file = file.path(run_SSMSE_dir,"plots","all_years_longterm_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_sel_rt_2, file = file.path(run_SSMSE_dir,"plots","sel_rt_2_longterm_kable.html"))
}
...
if(save == TRUE){
  save_kable(kable_sel_all_yrs, file = file.path(run_SSMSE_dir,"plots","sel_all_yrs_longterm_kable.html"))
}
...
create_reccom_plot_self_ref <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2047") {
  ...
  if(save == TRUE){
    ggsave(file.path(run_SSMSE_dir, "plots", paste0(title,"_self_ref", ".png")),
...
create_deadb_bias_plot_self_ref <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2047") {
  ...
  if(save == TRUE){
    ggsave(file.path(run_SSMSE_dir, "plots", paste0(title, "self_ref.png")),
           plot = p, width = 8, height = 6, units = "in", device = "png")
  }
...
create_relative_ssb_plot <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2047") {
...
create_relative_ssb_plot_self_ref <- function (min_year, max_year, scenario_list, scenario_name, model_run_type = "2047") {
